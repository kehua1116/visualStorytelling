...
def parse_opt():
    ...
    parser.add_argument('--hidden_dim', type=int, default=768)#default=1024)
    parser.add_argument('--num_layers', type=int, default=1, help='number of layers in the RNN')
    parser.add_argument('--word_embed_dim', type=int, default=768,
                        help='the encoding size of each token in the vocabulary, and the image.') #default=1024,
    ...
    parser.add_argument('--use_conv', type=str2bool, default=False)
    parser.add_argument('--story_size', type=int, default=5,
                        help='number of images/sentences appearing in each story')
    parser.add_argument('--with_position', type=str2bool, default=False,
                        help='whether to use position embedding for the image feature')
    
    parser.add_argument('--with_concepts', type=str2bool, default=True,
                        help='whether to add concept keywords during training')
    parser.add_argument('--emotion', type=str, default="no_emotion",
                        help='no_emotion | single_emotion | multi_emotion')
    parser.add_argument('--use_synonyms', type=str2bool, default=True,
                        help='applies only when emotion != "no_emotion", whether to use emotion_keywords or synonym keywords')
    ...
    parser.add_argument('--use_feature_with_context', type=str2bool, default=False)
    ...
    parser.add_argument('--load_best_score', type=str2bool, default=True,
