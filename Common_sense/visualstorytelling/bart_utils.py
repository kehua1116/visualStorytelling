...
class BARTModelWrapper(nn.Module):
    def __init__(self, opt):
        ...
        self._interface = torch.hub.load('pytorch/fairseq', 'bart.base', force_reload=True)
        # self._interface = BARTModel.from_pretrained('../../pretrained_models/bart_base', checkpoint_file='model.pt')
...
def forward_encoder(self, src_feat, keys, src_lengths, device_encoder, cls_input=None,
    ...
    # x = src_feat #removed common sense concepts
